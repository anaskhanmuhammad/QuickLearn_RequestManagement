            ...
            <div className="flex justify-center items-center flex-col w-1/6 bg-customGrey top-0 left-0 fixed h-screen m-0 p-0">
                ...
                <div className="h-4/5 flex justify-center items-center m-0 p-0 w-11/12 ">
                    <ul className="flex justify-evenly items-start flex-col mx-0 px-0 w-fit h-full text-white ">
                        <li className="w-full">
                            <NavLink
                                to="/student/ProfileAndPersonalization"
                                className={({ isActive }) =>
                        ...
                        <li className="w-full">
                            ...
                            >
                                <GiProgression className="m-4 text-3xl" />
                                <span>Self Learning</span>
                            </NavLink>
                        </li>
                        <li className="w-full">
                            <NavLink
                                to="/student/ProgressTrackingAndAnalytics"
                                className={({ isActive }) =>
                                    `flex justify-center items-center cursor-pointer hover:bg-customDark ${
                                        isActive ? "bg-customDark" : ""
                                    }`
                            ...
                            >
                                <TbDeviceDesktopAnalytics className="m-4 text-3xl" />
                                <span>Progress Tracking </span>
                            </NavLink>
                        </li>
                        <li className="w-full">
                            <NavLink
                                to="/student/RequestManagement"
                                className={({ isActive }) =>
                                    `flex justify-center items-center cursor-pointer hover:bg-customDark ${
                                        isActive ? "bg-customDark" : ""
                                    }`
                        ...
                        <li className="w-full">
                            <NavLink
                                to="/student/BridgingAlumniAndStudents"
                                className={({ isActive }) =>
                                    `flex justify-center items-center cursor-pointer hover:bg-customDark ${
                                        isActive ? "bg-customDark" : ""
                                    }`
